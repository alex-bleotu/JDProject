...
import { Leaf, Award, Scale, Droplets, TreePine } from 'lucide-react';
...
import { RecyclingContext } from '../contexts/RecycleContext';
...
export function Analytics() {
  ...
  const { recyclingData, error } = useContext(RecyclingContext);
            ...
            <div className="p-4 bg-secondary-50 dark:bg-secondary-900 rounded-lg">
              ...
              <div className="w-full bg-secondary-200 dark:bg-secondary-700 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${
                      (plasticKg / (plasticKg + metalKg + glassKg)) * 100
                    }%`,
                  }}
                />
              </div>
            ...
            <div className="p-4 bg-secondary-50 dark:bg-secondary-900 rounded-lg">
              ...
              <div className="w-full bg-secondary-200 dark:bg-secondary-700 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${
                      (metalKg / (plasticKg + metalKg + glassKg)) * 100
                    }%`,
                  }}
                />
              </div>
            ...
            <div className="p-4 bg-secondary-50 dark:bg-secondary-900 rounded-lg">
              ...
              <div className="w-full bg-secondary-200 dark:bg-secondary-700 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${
                      (glassKg / (plasticKg + metalKg + glassKg)) * 100
                    }%`,
                  }}
                />
              </div>
